...
const CONFIG = {
  ...
  seo: {
    title: 'Harmeet Singh Salech - Portfolio',
    description: 'Harmeet Singh Salech | Quality Assurance | Quality Consulting | Software Test Automation | Quality Practices and Metrics | DevOps',
